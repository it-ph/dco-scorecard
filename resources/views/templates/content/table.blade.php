                        ...
                        <?php $trow = $templateQueries->contentBaseonRow($template->id,$i); ?>
                            ...
                            @if($tq) <!--check if has result -->  
                                ...
                                @else
                                    ...
                                    <td style="vertical-align: middle;text-align: center"> <button class="btn btn-xs btn-danger" data-toggle="modal" data-target="#addModal-row{{$i}}-col{{$j}}"><i class="fa fa-plus"></i> Required </button>
                                       <br> <small style="font-weight: bold; color: red; font-size: 11px">Need to update this field</small>
                                    </td>
