...
<body>
    ...
    {{-- <section id="wrapper" class="login-register login-sidebar" style="background-image:url({{asset('images/login.jpg')}});"> --}}
        ...
        <div class="login-box card">
            <div class="card-body">
                <form id="login_form" method="POST" action="{{ route('verify.send') }}">
                    @csrf
                    ...
                    <div class="form-group m-t-30">
                        <div class="col-xs-12">
                            ...
                            <p class="text-muted">
                                <strong>Please type your Personiv Email to start the verification process. </strong>
                            </p>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="alert alert-danger" style="display: none; font-size: .80em" id="email_alert" role="alert"></div>
                            <input id="login-email" name="email" type="text" class="login-form-txt form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" required autofocus placeholder="Email Address">
                                @if($errors->has('email'))
                    ...
                    <div class="form-group m-t-10">
                        <div class="col-xs-4">
                            <button  type="submit" id="btnlogin" class="btn btn-warning btn-md text-uppercase btn-rounded login-not-allowed">Send</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <script src="{{asset('js/personiv.email.js')}}"></script>
